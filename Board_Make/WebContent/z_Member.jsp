...
%>
    <h2>회원가입</h2>
    <form action="z_Member" name="regform" id="regform" method="post" onsubmit="return sendit()">
        <!--method="post" 넘어갈때 보이지 않게 함  -->
        <!--제출을 누를때 onsubmit="return sendit() 에 따라서 넘어갈지 안넘어갈지 결정 -->
	...
	<p><a href="z_Login.jsp">로그인하러 가기</a></p>
	<%
		}
	%>
